...
namespace PlayersBook.Data.Migrations
{
    ...
    [Migration("20220907020406_Configs")]
            ...
            modelBuilder.Entity("PlayersBook.Domain.Entities.Advertisement", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 9, 6, 23, 4, 6, 167, DateTimeKind.Local).AddTicks(1326));
            ...
            modelBuilder.Entity("PlayersBook.Domain.Entities.Player", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 9, 6, 23, 4, 6, 167, DateTimeKind.Local).AddTicks(1757));
            ...
            modelBuilder.Entity("PlayersBook.Domain.Entities.Profile", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 9, 6, 23, 4, 6, 167, DateTimeKind.Local).AddTicks(2011));
