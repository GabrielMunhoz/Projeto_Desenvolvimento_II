...
namespace PlayersBook.Data.Migrations
{
    ...
    [Migration("20221022135622_added three new attributes on advertisement")]
    partial class addedthreenewattributesonadvertisement
    {
            ...
            modelBuilder.Entity("PlayersBook.Domain.Entities.Advertisement", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 10, 22, 10, 56, 22, 125, DateTimeKind.Local).AddTicks(3712));
            ...
            modelBuilder.Entity("PlayersBook.Domain.Entities.Player", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 10, 22, 10, 56, 22, 125, DateTimeKind.Local).AddTicks(4078));
            ...
            modelBuilder.Entity("PlayersBook.Domain.Entities.PlayerProfile", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 10, 22, 10, 56, 22, 125, DateTimeKind.Local).AddTicks(4230));
