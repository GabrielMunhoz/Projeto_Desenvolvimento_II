...
namespace PlayersBook.Data.Migrations
{
    ...
    [Migration("20221105001136_adjust1")]
            ...
            modelBuilder.Entity("PlayersBook.Domain.Entities.Advertisement", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 11, 4, 21, 11, 35, 827, DateTimeKind.Local).AddTicks(8726));
            ...
            modelBuilder.Entity("PlayersBook.Domain.Entities.ChannelStreams", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 4, 21, 11, 35, 827, DateTimeKind.Local).AddTicks(9159));
            ...
            modelBuilder.Entity("PlayersBook.Domain.Entities.Player", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 4, 21, 11, 35, 827, DateTimeKind.Local).AddTicks(9466));
            ...
            modelBuilder.Entity("PlayersBook.Domain.Entities.PlayerProfile", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 4, 21, 11, 35, 827, DateTimeKind.Local).AddTicks(9619));
