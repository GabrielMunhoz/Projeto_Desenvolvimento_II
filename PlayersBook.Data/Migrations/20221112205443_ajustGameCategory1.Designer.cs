...
namespace PlayersBook.Data.Migrations
{
    ...
    [Migration("20221112205443_ajustGameCategory1")]
    partial class ajustGameCategory1
    {
            ...
            modelBuilder.Entity("PlayersBook.Domain.Entities.Advertisement", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 11, 12, 17, 54, 43, 243, DateTimeKind.Local).AddTicks(5260));
            ...
            modelBuilder.Entity("PlayersBook.Domain.Entities.ChannelStreams", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 12, 17, 54, 43, 243, DateTimeKind.Local).AddTicks(5556));

                    b.Property<DateTime?>("DateUpdated")
                        .HasColumnType("datetime2");

                    b.Property<int>("IdTwitch")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PlayersBook.Domain.Entities.GamesCategory", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdTwitch"), 1L, 1);
            ...
            modelBuilder.Entity("PlayersBook.Domain.Entities.Player", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 12, 17, 54, 43, 243, DateTimeKind.Local).AddTicks(5728));
            ...
            modelBuilder.Entity("PlayersBook.Domain.Entities.PlayerProfile", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 12, 17, 54, 43, 243, DateTimeKind.Local).AddTicks(5911));
            ...
            modelBuilder.Entity("PlayersBook.Domain.Entities.PlayerProfile", b =>
                {
                    b.HasOne("PlayersBook.Domain.Entities.Player", "Player")
                        ...
                        .HasForeignKey("PlayersBook.Domain.Entities.PlayerProfile", "PlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
